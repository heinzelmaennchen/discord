# Bobby-B Quotes
# https://github.com/bobby-b-bot/utils/blob/master/quotes.json
bbquotes = [
    ...
    "GODS I WAS STRONG THEN", "START THE DAMN JOUST BEFORE I PISS MESELF!",
    "STOP THIS MADNESS, IN THE NAME OF YOUR KING!",
    "A DOTHRAKI HORDE ON AN OPEN FIELD, NED!", "GODS WHAT A STUPID NAME!",
    "WINE! WINE! MOOOOOOOOAR WINE!", "THANK THE GODS FOR BESSIE AND HER TITS",
    "YOU GOT FAT!",
    ...
    "HOLD YOUR TONGUE!", "WEAR IT IN SILENCE, OR I'LL HONOR YOU AGAIN!",
    ...
    "DID YOU HAVE TO BURY HER IN A PLACE LIKE THIS?", "SHE BELONGED WITH ME!",
