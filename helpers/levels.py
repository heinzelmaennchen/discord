...
def createRankcard(author, authornum, authorurl, rank, level, lvlxp, nlvlxp):
  ...
  bar = Image.new('RGB', (math.floor(lvlxp/nlvlxp*632),36), color = '#62d3f5')
  # ... und einfügen
  ...
  draw.text((234 + name_width[0] ,102), f'  #{authornum}', font = fntS, fill = '#7F8384')
  ...
  # XP - Text
  draw.text((866 - xp1_width[0] - xp2_width[0],102), strLvlXp, font = fntS, fill = (255,255,255))
  draw.text((866 - xp2_width[0],102),f" / {strNlvlxp} XP", font = fntS, fill = '#7F8384')
  # Level - Text
  draw.text((866 - lvlnum_width[0], 0), str(level), font = fntL, fill = '#62d3f5')
  draw.text((866 - lvlnum_width[0] - lvl_width[0], 36), "LEVEL", font = fntS, fill = '#62d3f5')
  # Rank - Text
  draw.text((866 - lvlnum_width[0] - lvl_width[0] - ranknum_width[0], 0), f"#{rank}", font = fntL, fill = '#ffffff')
  draw.text((866 - lvlnum_width[0] - lvl_width[0] - ranknum_width[0] - rank_width[0], 36), "RANK", font = fntS, fill = '#ffffff')
  # Shadow Background
